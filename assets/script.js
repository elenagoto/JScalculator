...
// This variable allows the user to use the final result for a new calculation
// but it gets erased when the user clicks on a new number right after equal.
let finalResult = '';
...
// if erase -> remove last item on display calculation
  if (changeKey === '←'){
...
// This function will use the variables above to display the elements on the page
